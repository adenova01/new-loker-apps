...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4"><?php echo app('translator')->get('app.createNew'); ?></h4>
                            ...
                            <p>You do not have any Location created. You need to create the Job location first to add
                                ...
                                <a href="<?php echo e(route('admin.locations.create')); ?>" class="btn btn-info btn-sm m-l-15"
                                   style="text-decoration: none;"><i
                                            class="fa fa-plus-circle"></i> <?php echo app('translator')->get('app.createNew'); ?> <?php echo app('translator')->get('menu.locations'); ?>
                                </a>
                            </p>
                        </div>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show">
                            ...
                            <p>You do not have any Job Category created. You need to create the Job location first to add
                                ...
                                <a href="<?php echo e(route('admin.job-categories.create')); ?>" class="btn btn-info btn-sm m-l-15"
                                   style="text-decoration: none;"><i
                                            class="fa fa-plus-circle"></i> <?php echo app('translator')->get('app.createNew'); ?> <?php echo app('translator')->get('menu.jobCategories'); ?>
                                </a>
                            </p>
                        </div>
                    <?php else: ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="address"><?php echo app('translator')->get('app.company'); ?></label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="address"><?php echo app('translator')->get('modules.jobs.jobTitle'); ?></label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="address"><?php echo app('translator')->get('modules.jobs.jobDescription'); ?></label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="address"><?php echo app('translator')->get('modules.jobs.jobRequirement'); ?></label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="address"><?php echo app('translator')->get('menu.locations'); ?></label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="address"><?php echo app('translator')->get('menu.jobCategories'); ?></label>
                                        <select name="category_id" id="category_id"
                                                class="form-control">
                                            <option value=""><?php echo app('translator')->get('app.choose'); ?> <?php echo app('translator')->get('menu.jobCategories'); ?></option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label><?php echo app('translator')->get('menu.skills'); ?></label>
                                        <select class="select2 m-b-10 select2-multiple" id="job_skills"
                                                style="width: 100%; " multiple="multiple"
                                                data-placeholder="<?php echo app('translator')->get('app.add'); ?> <?php echo app('translator')->get('menu.skills'); ?>"
                                                name="skill_id[]">
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="address"><?php echo app('translator')->get('modules.jobs.totalPositions'); ?></label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="address"><?php echo app('translator')->get('app.startDate'); ?></label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="address"><?php echo app('translator')->get('app.endDate'); ?></label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="address"><?php echo app('translator')->get('app.status'); ?></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="meta-title"><?php echo app('translator')->get('modules.jobs.metaTitle'); ?></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="meta-description"><?php echo app('translator')->get('modules.jobs.metaDescription'); ?></label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="">
                                                ...
                                                <?php echo e(ucfirst($question->question)); ?> <?php if($question->required == 'yes'): ?>
                                                    (<?php echo app('translator')->get('app.required'); ?>)<?php endif; ?>
                                            </label>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div id="columns">
                                        <label><?php echo app('translator')->get('app.askApplicantsFor'); ?></label>
                                ...
                                <div class="col-md-12">
                                    <div id="columns">
                                        <label><?php echo app('translator')->get('modules.jobs.sectionVisibility'); ?></label>
                                        <div class="form-group form-group-inline">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\loker-apps-new\resources\views/admin/jobs/create.blade.php ENDPATH**/ ?>