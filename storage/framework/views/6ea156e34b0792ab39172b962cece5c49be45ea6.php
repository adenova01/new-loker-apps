            ...
            <div class="col-md-8">
                <div class="row gap-y">
                    <div class="col-md-12">
                        ...
                        <h4 class="theme-color mt-20"><?php echo app('translator')->get('modules.jobs.jobDescription'); ?></h4>
                        ...
                        <h4 class="theme-color mt-20"><?php echo app('translator')->get('modules.jobs.jobRequirement'); ?></h4>
                        ...
                        <div class="my-30 text-center">
                            <a class="btn btn-lg btn-primary theme-background"
                               href="<?php echo e(route('jobs.jobApply', $job->slug)); ?>"><?php echo app('translator')->get('modules.front.applyForJob'); ?></a>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\loker-apps-new\resources\views/front/job-detail.blade.php ENDPATH**/ ?>