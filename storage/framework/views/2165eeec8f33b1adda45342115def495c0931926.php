                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <label for="address"><?php echo app('translator')->get('app.country'); ?></label>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" name="locations[]" class="form-control"
                                                    placeholder="<?php echo app('translator')->get('menu.locations'); ?> <?php echo app('translator')->get('app.name'); ?>">
            ...
            var divtest = `
                <div class="row removeclass${room}">
                    <div class="col-sm-9 nopadding">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" name="locations[]" class="form-control" placeholder="<?php echo app('translator')->get('menu.locations'); ?> <?php echo app('translator')->get('app.name'); ?>">
                                <div class="input-group-append"> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\loker-apps-new\resources\views/admin/locations/create.blade.php ENDPATH**/ ?>