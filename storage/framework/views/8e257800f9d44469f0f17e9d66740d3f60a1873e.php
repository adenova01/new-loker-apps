...
<div class="login-box" >
    <div class="login-logo" style="padding: 10px 0; background: var(--main-color);">
        <a href="#" >
            <img src="<?php echo e($setting->logo_url); ?>" style="max-height: 40px" alt="">
        </a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
...
</html><?php /**PATH C:\laragon\www\loker-apps-new\resources\views/layouts/auth.blade.php ENDPATH**/ ?>