            ...
            <div class="row">
                <div class="col-md-6  col-xs-12">
                    <div class="form-group">
                        ...
                        <select class="select2 m-b-10 form-control select2-multiple" multiple="multiple"
                                data-placeholder="<?php echo app('translator')->get('modules.interviewSchedule.chooseCandidate'); ?>" name="candidates[]">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select class="select2 m-b-10 form-control select2-multiple " multiple="multiple"
                                data-placeholder="<?php echo app('translator')->get('modules.interviewSchedule.chooseEmployee'); ?>" name="employees[]">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-success save-schedule"><?php echo app('translator')->get('app.submit'); ?></button>
</div>
...
<?php /**PATH C:\laragon\www\loker-apps-new\resources\views/admin/interview-schedule/create.blade.php ENDPATH**/ ?>