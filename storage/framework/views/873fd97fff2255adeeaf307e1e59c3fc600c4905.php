...
<?php $__env->startSection('create-button'); ?>
    <a href="<?php echo e(route('admin.job-applications.create')); ?>" class="btn btn-dark btn-sm m-l-15"><i
                class="fa fa-plus-circle"></i> <?php echo app('translator')->get('app.createNew'); ?></a>
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            ...
            <a href="javascript:createApplicationStatus();" class="btn btn-sm btn-success">
                ...
                <?php echo app('translator')->get('modules.jobApplication.newStatus'); ?>
            </a>
        </div>
        <div class="col-sm-6">
            <div id="search-container" class="form-group pull-right">
                <input id="search" class="form-control" type="text" name="search" placeholder="<?php echo app('translator')->get('modules.jobApplication.enterName'); ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <button type="button" id="reset-filters" class="btn btn-info btn-sm"><i class="fa fa-refresh"></i> <?php echo app('translator')->get('app.reset'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\loker-apps-new\resources\views/admin/job-applications/board.blade.php ENDPATH**/ ?>