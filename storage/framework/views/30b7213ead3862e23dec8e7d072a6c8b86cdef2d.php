    ...
    <form id="createForm" method="POST">
        ...
        <div class="row gap-y">
            ...
            <div class="col-md-4 px-20 pb-30">
                <h5><?php echo app('translator')->get('modules.front.personalInformation'); ?></h5>
            </div>
            ...
            <div class="col-md-8 pb-30">
                ...
                <div class="form-group">
                    <input class="form-control form-control-lg" type="text" name="full_name" placeholder="<?php echo app('translator')->get('modules.front.fullName'); ?>" value="<?php if($user): ?> <?php echo e($user->name); ?> <?php endif; ?>">
                </div>

                <div class="form-group">
                    <input class="form-control form-control-lg" type="email" name="email"
                            placeholder="<?php echo app('translator')->get('modules.front.email'); ?>" value="<?php if($user): ?> <?php echo e($user->email); ?> <?php endif; ?>">
                </div>

                <div class="form-group">
                    <input class="form-control form-control-lg" type="tel" name="phone"
                            placeholder="<?php echo app('translator')->get('modules.front.phone'); ?>">
                </div>

                <?php if($job->required_columns['gender']): ?>
                    <label class="control-label"><?php echo app('translator')->get('modules.front.gender'); ?></label>
                    <div class="form-group">
                ...
                <?php if($job->section_visibility['profile_image'] == 'yes'): ?>
                    <div class="form-group">
                        <h6><?php echo app('translator')->get('modules.front.photo'); ?></h6>
                        ...
                        <span><?php echo app('translator')->get('modules.front.photoFileType'); ?></span>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <?php if($job->section_visibility['resume'] == 'yes'): ?>
                <div class="col-md-4 px-20 pb-30 bt-1">
                    <h5><?php echo app('translator')->get('modules.front.resume'); ?></h5>
                </div>
            ...
            <?php if($job->section_visibility['cover_letter'] == 'yes'): ?>
                <div class="col-md-4 px-20 pb-30 bt-1">
                    <h5><?php echo app('translator')->get('modules.front.coverLetter'); ?></h5>
                </div>
                <div class="col-md-8 py-30 bt-1">
                    <div class="form-group">
            ...
            <?php if($job->section_visibility['terms_and_conditions'] == 'yes'): ?>
                <div class="col-md-4 px-20 pb-30 bt-1">
                    <h5><?php echo app('translator')->get('modules.front.legalTerm'); ?></h5>
                </div>
                <div class="col-md-8 py-30 bt-1">
                    <div class="form-group">
                    ...
                    <div class="form-group mt-30">
                            <label for="term_agreement" class="align-top" ><b><?php echo app('translator')->get('modules.front.agreeWithTerm'); ?></b></label>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\loker-apps-new\resources\views/front/job-apply.blade.php ENDPATH**/ ?>