            ...
            <div class="col-md-12" id="sticky-note-header">
                <div class="row">
                    <div class="col-md-10" style="line-height: 30px">
                        <?php echo app('translator')->get('app.menu.stickyNotes'); ?> <span class="badge badge-warning"><?php echo e($stickyNotes->count()); ?></span>
...
<?php /**PATH C:\laragon\www\loker-apps-new\resources\views/layouts/app.blade.php ENDPATH**/ ?>